...
public class MantenimientoContribuyentesJpa {
    ...
    public static void main(String[] args) {
        ...
        c.setNoNit("06141606791020");
        c.setNombreContribuyente("Xiomara Ramos");
        c.setRazonSocial("Cocina y Mas");
        c.setRentaAnual(new BigDecimal(5000.0));
        c.setRepresentanteLegal("Ricardo Acevedo");

//       System.out.println(man.guardarContribuyente(c));
//       SvContribuyentes contribuyente = man.consultarContribuyente("06141606791020");
//        
...
//            
//            man.modificarContribuyente("06141606791020", "Pancracia Perez");
