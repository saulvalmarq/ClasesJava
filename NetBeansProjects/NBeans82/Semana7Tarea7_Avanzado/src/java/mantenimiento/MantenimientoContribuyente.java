...
//        MantenimientoContribuyente man = MantenimientoContribuyente();
...
// Método Consultar (Read)
    ...
    public Contribuyente consultarContribuyente(String noNit) {
        ...
        if (contribuyente == null) {
            ...
            System.out.println("Fecha de Registro         :" + contribuyente.getFechaRegistro());
...
// Método Modificar (Update)
    ...
    public Contribuyente modificarContribuyente(String nit) throws ParseException{
        SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
        EntityManager em = JpaUtil.getEntityManagerFactory().createEntityManager();
        Contribuyente contribuyente = null;
