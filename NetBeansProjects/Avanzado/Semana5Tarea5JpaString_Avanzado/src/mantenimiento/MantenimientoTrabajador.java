...
//        trab.setNombreTrabajador("Ricardo Acevedo");
...
//
//        System.out.println(man.guardarTrabajador(trab));
//Consultar solo verifica que existe pero no presenta nada
//          System.out.println(man.consultarTrabajador("06142409731020"));
//        man.consultarTrabajador("06142409731020");
        //           System.out.println(man.consultarTrabajador("06142409731020"));
//    }
// Método guardar (Create)

    public int guardarTrabajador(Trabajador trabajador) {
...
// Ingreso de datos necesarios mediante teclado para el guardado de nuevos Estudiantes
        ...
        System.out.println("Ingrese por favor los Datos del Trabajador:");
...
// Método consultar (Read)
    ...
    public Trabajador consultarTrabajador(String noNit) {
        EntityManager em = JpaUtil.getEntityManagerFactory().createEntityManager();
        Trabajador empleado = null;
        Scanner dato1 = new Scanner(System.in);
        System.out.println("Ingrese el Número de Nit del Trabajador a Consultar:");
        ...
        if (empleado == null) {
            ...
            System.out.println("Nombre del Trabajador   :" + empleado.getNombreTrabajador());
...
// Método modificar (Update)
    ...
    public Trabajador modificarTrabajador(String nit) {
        EntityManager em = JpaUtil.getEntityManagerFactory().createEntityManager();
        Trabajador empleado = null;
        Scanner dato2 = new Scanner(System.in);
        System.out.println("Ingrese el Número de Nit del Trabajador a Modificar:");
        nit = dato2.nextLine();
        em.getTransaction().begin();
        try {
            empleado = em.find(Trabajador.class, nit);
        ...
        if (empleado == null) {
            System.out.println("Datos de Trabajador No Encontrados...");
        } else {
            ...
            while (flag2 == 0) {
                ...
                System.out.println("2 -Nombre del Trabajador");
                ...
                switch (sc1.nextInt()) {
                    case 2:
                        ...
                        try {
                            empleado = em.find(Trabajador.class, nit);
                            empleado.setNombreTrabajador(nom);
                            em.merge(empleado); //Update tabla de bd
                            em.getTransaction().commit();
                            System.out.println("Modificado");
                        } catch (Exception e) {
                        ...
                        break;
                    case 3:
                        System.out.println("Ingrese cambio en Fecha de Contratacion (dia/mes/año):");
...
// Método eliminar (Delete)
    ...
    public int eliminarTrabajador(String noNit) {
        EntityManager em = JpaUtil.getEntityManagerFactory().createEntityManager();
        Trabajador empleado = null;
        Scanner dato3 = new Scanner(System.in);
        System.out.println("Ingrese el Número de Nit del Trabajador a Eliminar:");
