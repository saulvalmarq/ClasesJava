...
public class PrincipalTresConstructor {
...
// Cuando es así basta con crear la instancia y automaticamente se invoca lo que este dentro del constructor
    ProcesosTresConstructor misProcesosTres=new ProcesosTresConstructor();
    }
}
